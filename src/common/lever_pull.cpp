...
ws::lever::PullScheduleUpdateResult ws::lever::update_pull_schedule(PullSchedule* pull) {
  ws::lever::PullScheduleUpdateResult result{};
  ...
  auto epoch_delta_t = ws::Duration(curr_t - pull->began_epoch);
  ...
  auto delta_t = ws::Duration(curr_t - pull->last_pull);
